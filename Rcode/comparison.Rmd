...
set.seed(1)
{
  ...
  c2track <- list()
  c3track <- list()
  al=1;bl=3;av=0.5;bv=2;am=10;bm=2;sigmal=1;mub=-2
  ;sigmab=1;arho=1;brho=1;psi_1=10;psi0=30;psi1=10;as=1;bs=1;sigmamu=1;
...
ob2= foreach(i=1:10,.packages=c("simFrame","progress","testarma","gtools")) %dopar% 
  {
    data <- generatedata_overlap(i)
    y <- data[[1]]
    #yna <- data[[2]]
