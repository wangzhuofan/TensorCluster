...
set.seed(1)
{
  ...
  ;sigmab=1;arho=1;brho=1;psi_1=1;psi0=8;psi1=1;as=1;bs=1;sigmamu=100;
...
sen= foreach(i=11:30,.packages=c("simFrame","progress","testarma","gtools")) %dopar% 
  {
    data <- generatedata_overlap(i)
    y <- data[[1]]
    #yna <- data[[2]]
...
senres = foreach(i=11:30,.combine=rbind,.packages=c("progress","testarma","gtools")) %dopar%
  {
    data <- generatedata_overlap(i)
    #y <- data[[1]]
    #yna <- data[[2]]
